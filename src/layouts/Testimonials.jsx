...
import test1 from "../assets/myimg/marqee/test1.png"
...
const Testimonials = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center lg:px-16 px-5 -mt-23">
      <div className='flex justify-center text-[#000F38] lg:text-4xl text-3xl  mb-2 font-bold '>What Our Patients Say ?  </div>
        <div className='flex justify-center text-[#0A4B7F] font-semibold mb-20'>TESTIMONIALS</div>
